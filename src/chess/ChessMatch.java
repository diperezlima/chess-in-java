...
public class ChessMatch {
	...
	public boolean[][] possibleMoves(ChessPosition sourcePosition) { //method to set possible moves from source position
	...
	private Piece makeMove(Position source, Position target) {
		Piece p = board.removePiece(source); //remove the piece from source position
	...
	private void nextTurn() { 
		...
		currentPlayer = (currentPlayer == Color.WHITE) ? Color.BLACK : Color.WHITE; //selected player to move will change
	}
